...
import cl from './insurance.module.scss'

const Insurance = ({ insuranceList, comboboxValues }) => {
	...
	return (
		<>
			{insuranceList.map(({ title, description, titleMobile, btn, policyText, policyLink, image }) => (
				<>
