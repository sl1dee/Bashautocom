...
import cl from './detailing.module.scss'

const Detailing = ({ detailingList, comboboxValues }) => {
	...
	return (
		<>
			{detailingList.map(({ title, description, titleMobile, btn, policyText, policyLink, image }) => (
				<>
