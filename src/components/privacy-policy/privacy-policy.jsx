			...
			<div className="container">
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						меры по обеспечению безопасности персональных данных, предпринимаемые ООО "Башкирская автомобильная
						компания"; ИНН 0245015798, ОГРН 1060245000210; (далее – Оператор).
					</p>
					<p>
					...
					<p>
						...
						<a href="https://bashauto.com/">https://bashauto.com/</a>.
					</p>
				</div>
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						определяемому Пользователю веб-сайта <a href="https://bashauto.com/">https://bashauto.com/</a>;
					</p>
					<p>
						2.9. Пользователь – любой посетитель веб-сайта <a href="http://bashauto.com">http://bashauto.com</a>;
					</p>
					<p>
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						<a href="mailto:a.baikova@bashauto.com">a.baikova@bashauto.com</a> с пометкой «Отказ от уведомлений о новых
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						<a href="http://bashauto.com">http://bashauto.com</a>. Заполняя соответствующие формы и/или отправляя свои
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						<a href="http://bashauto.com">http://bashauto.com</a> с пометкой «Актуализация персональных данных».
					</p>
					<p>
						...
						на электронный адрес Оператора <a href="mailto:a.baikova@bashauto.com">a.baikova@bashauto.com</a> с пометкой
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						<a href="mailto:a.baikova@bashauto.com">a.baikova@bashauto.com</a>.
					</p>
					<p>
					...
					<p>
						...
						<a href="https://bashauto.com/about/policy">https://bashauto.com/about/policy</a>;
					</p>
				</div>
			</div>
		</div>
