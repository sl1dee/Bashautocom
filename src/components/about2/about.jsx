import four from '@media/about2/four.jpg'
import one from '@media/about2/one.jpg'
import three from '@media/about2/three.jpg'
import two from '@media/about2/two.jpg'
